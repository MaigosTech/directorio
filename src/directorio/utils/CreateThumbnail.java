...
{ 
	public static Logger log = Logger.getLogger(CreateThumbnail.class.getName());
  ...
  public void saveThumbnail(File file, String imageType)
  {
		if (thumb != null)
		{
			 ...
			 {
				  log.debug("Error occured saving thumbnail");
			 }
		}
		else
		{
			 log.debug("Thumbnail has not yet been created");
		}
  }
